...
// @mysqli_connect("127.0.0.1:3306", "root", "bala123", "fashion_loft");
// @mysqli_select_db("fashion_loft");

$result=mysqli_query($link, "select Ename, Pwd, EID, mail, city,Phno from employee where Ename='$username' and Pwd='$password'") or die("failed".mysql_error());
$row=mysqli_fetch_assoc($result);
$result2=mysqli_query($link, "select distinct employee.EID, Pwd, Ename, empandbuyer.BID, empandbuyer.EID from empandbuyer, employee where Ename='$username' and Pwd='$password' and employee.EID=empandbuyer.EID") or die("failed".mysql_error());
